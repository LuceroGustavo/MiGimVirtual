...
INSERT INTO rutina (nombre, descripcion, estado, fecha_creacion, fecha_modificacion, es_plantilla, creador, categoria, token_publico, usuario_id, profesor_id)
VALUES ('Rutina Fuerza Completa', 'Rutina de 3 días para desarrollo muscular general.', 'ACTIVA', NOW(), NOW(), 1, 'ADMIN', 'FUERZA', 'test_rutina1_abc123456789', NULL, @profesor_id);
...
INSERT INTO rutina (nombre, descripcion, estado, fecha_creacion, fecha_modificacion, es_plantilla, creador, categoria, token_publico, usuario_id, profesor_id)
VALUES ('Full Body + Cardio', 'Circuito completo con cardio. Ideal para días cortos.', 'ACTIVA', NOW(), NOW(), 1, 'ADMIN', 'FUERZA,CARDIO', 'test_rutina2_def456789012', NULL, @profesor_id);
...
INSERT INTO rutina (nombre, descripcion, estado, fecha_creacion, fecha_modificacion, es_plantilla, creador, categoria, token_publico, usuario_id, profesor_id)
VALUES ('Upper Body + Lower Body', 'Split clásico superior/inferior.', 'ACTIVA', NOW(), NOW(), 1, 'ADMIN', 'FUERZA', 'test_rutina3_ghi789012345', NULL, @profesor_id);
...
INSERT INTO rutina (nombre, descripcion, estado, fecha_creacion, fecha_modificacion, es_plantilla, creador, categoria, token_publico, usuario_id, profesor_id)
VALUES ('Hombros y Movilidad', 'Desarrollo de hombros con elongación final.', 'ACTIVA', NOW(), NOW(), 1, 'ADMIN', 'FUERZA,FLEXIBILIDAD', 'test_rutina4_jkl012345678', NULL, @profesor_id);
...
INSERT INTO rutina (nombre, descripcion, estado, fecha_creacion, fecha_modificacion, es_plantilla, creador, categoria, token_publico, usuario_id, profesor_id)
VALUES ('Alta Intensidad - Push Pull', 'Rutina avanzada de empuje y tirón.', 'ACTIVA', NOW(), NOW(), 1, 'ADMIN', 'FUERZA,CARDIO', 'test_rutina5_mno345678901', NULL, @profesor_id);
